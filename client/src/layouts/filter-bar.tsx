...
import { FilterBarExport } from "./filter-bar-export";
...
export const FilterBar = React.memo(function FilterBar() {
  ...
  return (
    <div className="flex items-center overflow-x-auto gap-3 bg-white border-b border-slate-200 w-full p-3 min-w-0 min-h-18.25 print:hidden">
