...
export function PieChart({ id, title, data }: PieChartProps) {
  ...
  useLayoutEffect(() => {
    ...
    const am4themes_animated =
      require("@amcharts/amcharts4/themes/animated").default;
    ...
    if (chartType === "pie") {
      ...
      hoverState.properties.shiftRadius = 0.1; // Pull out 15% from center (default is usually smaller or 0)
